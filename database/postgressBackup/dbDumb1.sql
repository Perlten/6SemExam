...
-- Started on 2020-05-21 14:38:21 CEST
...
7	26104	2020-05-21	f	1234567891234561	5ec6696a1b9f5c8f7dc4d876
8	21104	2020-05-21	f	1234567891234561	5ec669af5def2d8fc602fd86
9	21104	2020-05-21	f	1234567891234561	5ec66a13ef6c9f9073a88527
10	21104	2020-05-21	f	1234567891234561	5ec66a411e1d1590c2d24d93
6	1.0026092e+07	2020-05-21	t	1234567891234561	5ec66927d9d22c8f27f19129
11	21104	2020-05-21	t	1234567891234561	5ec66a431e1d1590c2d24d94
\.
...
SELECT pg_catalog.setval('public.namelog_id_seq', 9, true);
...
--
-- TOC entry 2838 (class 2620 OID 41055)
-- Name: accounts updatenametrigger; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER updatenametrigger AFTER UPDATE ON public.accounts FOR EACH ROW EXECUTE FUNCTION public.update_name_log();
...
-- Completed on 2020-05-21 14:38:21 CEST
